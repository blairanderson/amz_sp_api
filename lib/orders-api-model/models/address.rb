...
module AmzSpApi::OrdersApiModel
  ...
  class Address
    ...
    def hash
      [name, address_line1, address_line2, address_line3, city, county, district, state_or_region, municipality, postal_code, country_code, phone, extended_fields, address_type].hash
    end
